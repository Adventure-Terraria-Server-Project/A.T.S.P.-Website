            ...
            <div class="row content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {% if nickban or ipban %}<div class="panel panel-danger">
                        ...
                        {% if msgs %}<div class="panel panel-primary">
                        ...
                        <h3 class="text-primary text-center">You don't have unread messages!</h3>{% endif %}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        {% if user_data['staff'] %}<h2 class="text-info text-center">User Reports</h2>
                        <table class="table table-bordered"><tr><th>ID</th><th>Reported by</th><th>Reported User</td><th>Reason</th></tr>{{reports}}</table>{% endif %}
                        ...
                        {% if user_data['user'][1] == 'superadmin' %}<div id="backups" style="width: 100%; height: 400px"></div>{% endif %}
                    </div>
                </div>
            </div><br>{% endblock %}